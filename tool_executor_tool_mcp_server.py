...
def replace_whole_word(path: str, old_word: str, new_word: str) -> str:
    ...
    Returns:
        A success message or an error description.
    """
    return _post("/replace-word", {"path": path, "old": old_word, "new": new_word})
...
def replace_text(path: str, old_text: str, new_text: str) -> str:
    ...
    Returns:
        A success message or an error description.
    """
    return _post("/replace-text", {"path": path, "old": old_text, "new": new_text})
...
def agent_commit(path: str, context: str) -> str:
    ...
    Returns:
        A success message or an error description.
    """
    return _post("/git/commit", {"path": path, "context": context})
...
def agent_push(path: str) -> str:
    ...
    Returns:
        A success message or an error description.
    """
    return _post("/git/push", {"path": path})
